...
import { fetchParticipant, fetchParticipantPhotos } from 'actions/participant';
...
class ParticipantPreview extends React.Component {
  componentDidMount() {
    ...
    this.props.dispatch(fetchParticipant(id));
    this.props.dispatch(fetchParticipantPhotos(id));
  }
  ...
  render() {
    ...
    const { photos } = this.props.participant;
    ...
    return (
      <section className="page">
        ...
        <section className="page__content">
          ...
          {(photos.length) ? (
            <SmallGallery photos={photos} title="Participant photos" />
          ) : null}
