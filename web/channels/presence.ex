defmodule EmotionsWheelBackend.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule EmotionsWheelBackend.MyChannel do
        use EmotionsWheelBackend.Web, :channel
        alias EmotionsWheelBackend.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :emotions_wheel_backend,
                        pubsub_server: EmotionsWheelBackend.PubSub
end
